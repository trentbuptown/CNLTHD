...
const MyAccount = () => {
	...
	const logoutHandler = async () => {
		try {
			// First dispatch logout action to context
			dispatch({
				type: 'LOGOUT',
				payload: undefined,
			});
			// Let the service handle the rest (storage clearing, redirect, etc.)
			await Users.logoutUser();
			// No need for addToast or Router.push here as logoutUser will redirect
		} catch (error: any) {
